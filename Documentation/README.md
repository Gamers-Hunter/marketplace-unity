 ...
 * Unity 2018.1 or newer is required. GamersHunter Package was made using Unity 2021 so that or newer is preferred. Keep your software up to date! 
...
If your app is not performance heavy, consider loading markets on Init, this will make sure the Marketplace is loaded and ready to go without making the user wait for it to load. If you want to use all the performance for your game, leave this unchecked. 
