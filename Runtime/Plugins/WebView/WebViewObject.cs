...
public class WebViewObject : MonoBehaviour
{
    ...
    public void SetMargins(int left, int top, int right, int bottom, bool relative = false, int rectWidth = 400, int rectHeight = 800)
    {
...
#elif UNITY_EDITOR_OSX || UNITY_STANDALONE_OSX
        _CWebViewPlugin_SetRect(webView, rectWidth, rectHeight);
        rect = new Rect(left, bottom, Screen.width, Screen.height);
#elif UNITY_IPHONE
